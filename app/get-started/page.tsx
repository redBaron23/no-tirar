    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-teal-50 to-white text-gray-800">
      <header className="sticky top-0 z-10 bg-teal-500 p-4 shadow-md transition-all duration-300 ease-in-out">
        <nav className="container mx-auto flex items-center justify-between">
          ...
          />
          <button className="flex items-center rounded-full bg-amber-500 px-6 py-2 text-white shadow-md transition-all duration-300 hover:bg-amber-600 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-amber-300">
      ...
      <main className="container mx-auto flex-grow px-4 py-8 sm:py-16">
        <section className="mb-12 text-center sm:mb-20">
          ...
          <button className="group relative overflow-hidden rounded-full bg-teal-500 px-8 py-3 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:bg-teal-600 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-teal-300 sm:px-10 sm:py-4">
