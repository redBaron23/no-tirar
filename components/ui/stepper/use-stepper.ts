...
import { StepperContext, StepperContextValue } from "./context";
...
export function useStepper<T = any>() {
  const context = React.useContext(StepperContext) as StepperContextValue<T>;
